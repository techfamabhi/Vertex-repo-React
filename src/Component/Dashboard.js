                             ...
                             <div className="col-md-3 mb-3">
                                                <div className="card">
                                                    <div className="card-body">
                                                        ...
                                                        <span className="fw-semibold d-block mb-1">User Balance</span>
                                                        <h3 className="card-title mb-2">1,12,628.80</h3>
...
<div class="container-fluid">
    <div class="row">
              <div class="card">
                <h5 class="card-header">Multiple Account History</h5>
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><span class="">9373960366</span></td>
                          <td><span class="">abhishekgouda882@gmail.com</span></td>
                          <td><span class="">8888888</span></td>
                          <td><span class="badge bg-label-primary me-1">Not Yet</span></td>
                          <td><span class="badge bg-label-primary me-1">Active</span></td>
                          <td><span class="">2023-04-22</span></td>
                          <td><span class="badge bg-label-primary me-1">Active</span></td>
                ...
                <div className="buy-now">
                    <a href="https://themeselection.com/products/sneat-bootstrap-html-admin-template/"
                        target="_blank" className="btn btn-danger btn-buy-now">Upgrade to Pro</a>
                </div>
